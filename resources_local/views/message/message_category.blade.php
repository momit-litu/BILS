...
@section('content')
    ...
    <div class="row ">
    	<ul class="nav nav-tabs tab-padding tab-space-3 tab-blue" id="myTab4">
            <li class="active">
                <a data-toggle="tab" href="#message_category_management">
                   <b>Survey Category Management</b>
                </a>
            </li>
        </ul>
        <div class="tab-content">
			<div id="message_category_management" class="tab-pane in active">
				<div class="col-sm-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row no-margin-row">
									<form id="save_message_category_form" name="save_message_category_form" enctype="multipart/form-data" class="form form-horizontal form-label-left">
										@csrf
										<div class="row">
											<input type="hidden" name="message_category_edit_id" id="message_category_edit_id">
											<div class="col-md-12">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="row no-margin-row">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table class="table table-bordered table-hover" id="message_category" style="width:100% !important">
										<thead>
											<tr>
												<th>ID</th>
												<th>Category Name</th>
