								...
								<form id="save_publication_category_form" name="save_publication_category_form" enctype="multipart/form-data" class="form form-horizontal form-label-left">
									...
									<div class="row">
										...
										<div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-6">Category Name In Bengla<span class="required">*</span></label>
                                                <div class="col-md-9 col-sm-9 col-xs-6">
									...
									<div class="form-group">
										...
										<div class="col-md-5 col-sm-5 col-xs-12">
											...
											@endif
											<button type="button" id="cancle_publication_category" class="btn btn-danger hidden">Cancel</button>
										</div>
										<div class="col-md-5 col-sm-5 col-xs-12">
