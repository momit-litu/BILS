...
Route::group(['middleware'=>'appUser'], function() {
    ...
    Route::get('app/load-notice/{page}/{search}',array('as'=>'Notice' , 'uses' =>'FrontEndController@userNotice'));
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/message/admin-group-message-seen/{groupId}',array('as'=>'group message seen', 'uses' =>'MessageController@newGroupMessageSeen'));
