...
class NotificationController extends Controller
{
    ...
    public function newNotificationLoad(){
        $notifications = DB::table('notifications as nf')
            ...
            ->select('nf.id as id', 'nf.from_id as app_user_id', 'nf.notification_title as notification','nf.created_at as created_at', 'nf.message as details',  'apu.name as app_user_name','apu.user_profile_image')
            ->groupBy('nf.id')
