...
$(document).ready(function(){
	alert("NOtice");
		...
		$("#notification-sidebar .media a").on("click", function(e) {
			alert($("#notification-sidebar").outerWidth())
			$(this).closest(".tab-pane").css({
				right: $("#notification-sidebar").outerWidth()
			});
			e.preventDefault();
		});
		$("#notification-sidebar .sidebar-back").on("click", function(e) {
			$(this).closest(".tab-pane").css({
				right: 0
			});
			e.preventDefault();
		});
		$('#notification-sidebar .sidebar-wrapper').perfectScrollbar({
			wheelSpeed: 50,
		...
		$('#sidebar-tab a').on('shown.bs.tab', function (e) {
		 ...
		 $("#notification-sidebar .sidebar-wrapper").perfectScrollbar('update');
		});
